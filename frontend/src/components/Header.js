export default {
  ...
  template: `
    <header class="fixed top-0 left-0 right-0 z-50 h-16 bg-gradient-to-r from-purple-500 to-violet-600 text-white shadow-lg flex items-center justify-between px-6 py-3">
